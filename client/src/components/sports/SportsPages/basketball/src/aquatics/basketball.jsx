    ...
    <div className='aq-pageContainer'>
      ...
      <div className='facilities'>
        ...
        <div className='content'>
          ...
          <img alt="alt" src={bb1} className='image' />
        </div>
      </div>
      ...
      <div className='contacts'>
        ...
        <div className='contactlist'>
          <div className='contactCard' >
            <img alt="alt" src={deep} className='contactImg' />
      ...
      <div className='location'>
        ...
        width="700" height="450" className='map' allowFullScreen="" loading="lazy" title="basketball court location" referrerPolicy="no-referrer-when-downgrade"></iframe>
